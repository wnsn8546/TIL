...
```sql
SELECT is_drinking, smoking, weight / AVG(((height * 0.01) * (height * 0.01))) AS BMI FROM healthcare WHERE smoking <> '' and is_drinking <> '' GROUP BY is_drinking, smoking;
```
```
is_drinking  smoking  BMI
-----------  -------  ----------------
0            1        24.8260948992881
0            2        25.6096423732472
0            3        23.8154519802896
1            1        29.3170645436567
1            2        26.6956730180184
1            3        30.1738906262366
```